...
<!--             <v-btn color="red" v-if="isAuth" @click="$router.push({name: 'presentation'})" icon="mdi-file-powerpoint"></v-btn> -->
            <v-btn color="blue" v-if="isAuth" @click="$router.push({name: 'projects'})" icon="mdi-file-tree"></v-btn>
            <router-link v-if="isAuth" to="/chat">
                <v-btn color="blue" icon="mdi-forum"></v-btn>
            </router-link>
